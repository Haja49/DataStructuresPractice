...
Explaination: calories[0] + calories[1] > upper, calories[2] + calories[3] < lower, total points = 0
	...
	/*
	 * 1. Iterate till k and get the sum
	 * 2. If sum is less than lower, decrement counter
	 * 		a) else if greater, increment counter
	 * 3. Iterate through the length of array from k
	 * 4. Remove first element and add k+1
	 * 5. If sum is less than lower, decrement counter
	 * 		a) else if greater, increment counter
