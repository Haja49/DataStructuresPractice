...
public class RemoveMultipleDuplicates {
	 ...
	 * [0,0,1,1,2,3,3] Explanation: Your function should return length = 7, with the
	 * first seven elements of nums being modified to 0, 0, 1, 1, 2, 3 and 3
	...
	/*
	 * 1. If length is less than 2, return length 2. Initialize 2 variables, count
	 * and left 3. While left < input length a) if input[left] is not equal to
	 * input[count-2] b) assign input[left] to input[count] and increment count and
	 * left 4. Increment left 5. Finally return count
	 */
